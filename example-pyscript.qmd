---
title: Panel and HoloViz in Quarto powered by PyScript
format: html
include-in-header:
    - example-pyscript-header.html
---

This documents shows you how Panel and the HoloViz ecosystem can render in Quarto with live interactivity powered by PyScript.
...
In addition you would need to configure PyScript and *Panel in PyScript* once.
