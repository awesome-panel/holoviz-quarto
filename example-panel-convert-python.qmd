...
With this filter you can insert entire, templated applications into your documents. The downside is that the load time increases linearly with the number of applications you insert.
...
You will need to install and configure the `quarto-holoviz` extension as described in the [Getting Started](getting-started.qmd) guide.
